...
void TPinballTable::tilt(float time)
{
	if (!TiltLockFlag && !BallInSink)
	{
		...
		pinball::InfoTextBox->Display(pinball::get_rc_string(IDS_STRING136, 0), -1.0);
...
int TPinballTable::Message(int code, float value)
{
	...
	case 1013:
		...
		if (Demo && Demo->ActiveFlag)
			rc_text = pinball::get_rc_string(IDS_STRING131, 0);
		else
			rc_text = pinball::get_rc_string(IDS_STRING127, 0);
	...
	case 1021:
		{
			if (PlayerCount <= 1)
			{
				char* textboxText;
				if (Demo->ActiveFlag)
					textboxText = pinball::get_rc_string(IDS_STRING131, 0);
				else
					textboxText = pinball::get_rc_string(IDS_STRING127, 0);
			...
			case 1:
				if (Demo->ActiveFlag)
					textboxText = pinball::get_rc_string(IDS_STRING132, 0);
				else
					textboxText = pinball::get_rc_string(IDS_STRING128, 0);
				break;
			case 2:
				if (Demo->ActiveFlag)
					textboxText = pinball::get_rc_string(IDS_STRING133, 0);
				else
					textboxText = pinball::get_rc_string(IDS_STRING129, 0);
				break;
			case 3:
				if (Demo->ActiveFlag)
					textboxText = pinball::get_rc_string(IDS_STRING134, 0);
				else
					textboxText = pinball::get_rc_string(IDS_STRING130, 0);
				break;
			default:
				break;
			}
	...
	case 1022:
		...
		pinball::MissTextBox->Clear();
		pinball::InfoTextBox->Display(pinball::get_rc_string(IDS_STRING135, 0), -1.0);
...
void TPinballTable::EndGame_timeout(int timerId, void* caller)
{
	...
	pinball::InfoTextBox->Display(pinball::get_rc_string(IDS_STRING125, 0), -1.0);
}
