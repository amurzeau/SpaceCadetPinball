...
const std::map<uint32_t, const char*> rc_strings_german = {
    ...
    { IDS_Menu1_Player_Controls, "Bedienung..." },
    ...
    { IDS_Menu1_Help, "?" },
    { IDS_Menu1_Help_Topics, "Hilfethemen" },
