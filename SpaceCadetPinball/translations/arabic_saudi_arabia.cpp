...
const std::map<uint32_t, const char*> rc_strings_arabic_saudi_arabia = {
    { IDS_Menu1_Game, "لعبة" },
    { IDS_Menu1_New_Game, "لعبة جديدة" },
    { IDS_Menu1_Launch_Ball, "إطلاق الكرة" },
    { IDS_Menu1_Pause_Resume_Game, "إيقاف مؤقت/استئناف اللعبة" },
    { IDS_Menu1_High_Scores, "أفضل النتائج..." },
    { IDS_Menu1_Demo, "عرض" },
    { IDS_Menu1_Exit, "إنهاء" },
    { IDS_Menu1_Options, "خيارات" },
    { IDS_Menu1_Full_Screen, "ملء الشاشة" },
    { IDS_Menu1_Select_Table, "تحديد طاولة" },
    { IDS_Menu1_Select_Players, "تحديد اللاعبين" },
    { IDS_Menu1_1Player, "لاعب واحد" },
    { IDS_Menu1_2Players, "لاعبان" },
    { IDS_Menu1_3Players, "ثلاثة لاعبين" },
    { IDS_Menu1_4Players, "أربعة لاعبين" },
    { IDS_Menu1_Sounds, "أصوات" },
    { IDS_Menu1_Music, "موسيقى" },
    { IDS_Menu1_Player_Controls, "عناصر تحكم اللاعب..." },
    ...
    { IDS_Menu1_Help_Topics, "مواضيع التعليمات" },
    ...
    { IDS_KEYMAPPER_Default, "الافتراضي" },
    { IDS_KEYMAPPER_FlipperL, "المضرب الأيسر" },
    { IDS_KEYMAPPER_FlipperR, "المضرب الأيمن" },
    { IDS_KEYMAPPER_BumpLeft, "المصد الأيسر في الطاولة" },
    { IDS_KEYMAPPER_BumpRight, "المصد الأيمن في الطاولة" },
    { IDS_KEYMAPPER_BumpBottom, "المصد السفلي في الطاولة" },
    { IDS_KEYMAPPER_Plunger, "الزناد" },
