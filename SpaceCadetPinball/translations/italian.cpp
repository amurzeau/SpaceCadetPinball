...
const std::map<uint32_t, const char*> rc_strings_italian = {
    ...
    { IDS_Menu1_Full_Screen, "Schermo intero\tF4" },
    { IDS_Menu1_Select_Table, "Seleziona tabella" },
    { IDS_Menu1_Select_Players, "Seleziona giocatori" },
    ...
    { IDS_KEYMAPPER_FlipperR, "Flipper destro" },
    { IDS_KEYMAPPER_BumpLeft, "Spinta da sinistra" },
    { IDS_KEYMAPPER_BumpRight, "Spinta da destra" },
    { IDS_KEYMAPPER_BumpBottom, "Spinta dal basso" },
    { IDS_KEYMAPPER_Plunger, "Lanciapalline" },
