...
const std::map<uint32_t, const char*> rc_strings_italian = {
    ...
    { IDS_Menu1_Player_Controls, "Controlli giocatore..." },
    ...
    { IDS_Menu1_Help, "?" },
    { IDS_Menu1_Help_Topics, "Guida in linea" },
