...
const std::map<uint32_t, const char*> rc_strings_polish = {
    ...
    { IDS_Menu1_Pause_Resume_Game, "Ws&trzymaj/wznów grę\tF3" },
    { IDS_Menu1_High_Scores, "Najlepsze &wyniki..." },
    { IDS_Menu1_Demo, "&Pokaz" },
    { IDS_Menu1_Exit, "Za&kończ" },
    ...
    { IDS_Menu1_Player_Controls, "St&erowniki gracza...\tF8" },
    ...
    { IDS_KEYMAPPER_BumpRight, "Ud&erzenie w stół z prawej strony" },
