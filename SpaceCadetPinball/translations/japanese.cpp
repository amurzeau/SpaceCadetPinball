...
const std::map<uint32_t, const char*> rc_strings_japanese = {
    { IDS_Menu1_Game, "ゲーム" },
    { IDS_Menu1_New_Game, "スタート\tF2" },
    { IDS_Menu1_Launch_Ball, "ボール発射" },
    { IDS_Menu1_Pause_Resume_Game, "一時停止/ゲーム再開\tF3" },
    { IDS_Menu1_High_Scores, "ハイスコア..." },
    { IDS_Menu1_Demo, "デモンストレーション" },
    { IDS_Menu1_Exit, "3D ピンボールの終了" },
    { IDS_Menu1_Options, "オプション" },
    { IDS_Menu1_Full_Screen, "全画面表示\tF4" },
    { IDS_Menu1_Select_Table, "テーブルの選択" },
    { IDS_Menu1_Select_Players, "プレーヤーの選択" },
    { IDS_Menu1_1Player, "1 人" },
    { IDS_Menu1_2Players, "2 人" },
    { IDS_Menu1_3Players, "3 人" },
    { IDS_Menu1_4Players, "4 人" },
    { IDS_Menu1_Sounds, "サウンド" },
    { IDS_Menu1_Music, "音楽" },
    { IDS_Menu1_Player_Controls, "コントロールの設定...\tF8" },
    ...
    { IDS_Menu1_Help, "ヘルプ" },
    { IDS_Menu1_Help_Topics, "トピックの検索\tF1" },
    { IDS_Menu1_About_Pinball, "バージョン情報" },
    { IDS_HIGHSCORES_Caption, "ハイスコア" },
    { IDS_HIGHSCORES_Ok, "OK" },
    { IDS_HIGHSCORES_Cancel, "キャンセル" },
    { IDS_HIGHSCORES_Clear, "クリア" },
    ...
    { IDS_KEYMAPPER_Default, "既定" },
    { IDS_KEYMAPPER_FlipperL, "左フリッパー" },
    { IDS_KEYMAPPER_FlipperR, "右フリッパー" },
    { IDS_KEYMAPPER_BumpLeft, "左テーブル バンプ" },
    { IDS_KEYMAPPER_BumpRight, "右テーブル バンプ" },
    { IDS_KEYMAPPER_BumpBottom, "ボトムテーブル バンプ" },
    { IDS_KEYMAPPER_Plunger, "プランジャー" },
