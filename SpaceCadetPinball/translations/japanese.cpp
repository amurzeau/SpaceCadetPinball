...
const std::map<uint32_t, const char*> rc_strings_japanese = {
    ...
    { IDS_Menu1_Music, "音楽" },
    { IDS_Menu1_Player_Controls, "コントロールの設定..." },
