...
const std::map<uint32_t, const char*> rc_strings_greek = {
    ...
    { IDS_Menu1_Player_Controls, "Στοιχεία ελέγχου του παίχτη..." },
    ...
    { IDS_Menu1_Help_Topics, "Θέματα στη Βοήθεια" },
