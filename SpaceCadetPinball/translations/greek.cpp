...
const std::map<uint32_t, const char*> rc_strings_greek = {
    ...
    { IDS_HIGHSCORES_Clear, "Απαλ&οιφή" },
    ...
    { IDS_KEYMAPPER_FlipperL, "Α&ριστερή ρακέτα" },
    { IDS_KEYMAPPER_FlipperR, "Δε&ξιά ρακέτα" },
    { IDS_KEYMAPPER_BumpLeft, "Αριστερό χ&τύπημα" },
    { IDS_KEYMAPPER_BumpRight, "Δεξιό &χτύπημα" },
    { IDS_KEYMAPPER_BumpBottom, "Χτύπημα από &κάτω" },
    { IDS_KEYMAPPER_Plunger, "Ε&λατήριο" },
