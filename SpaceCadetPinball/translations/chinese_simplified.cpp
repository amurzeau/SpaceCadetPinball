...
const std::map<uint32_t, const char*> rc_strings_chinese_simplified = {
    { IDS_Menu1_Game, "游戏" },
    { IDS_Menu1_New_Game, "开局\tF2" },
    { IDS_Menu1_Launch_Ball, "发射球" },
    { IDS_Menu1_Pause_Resume_Game, "暂停/继续游戏\tF3" },
    { IDS_Menu1_High_Scores, "高分..." },
    { IDS_Menu1_Demo, "演示" },
    { IDS_Menu1_Exit, "退出" },
    { IDS_Menu1_Options, "选项" },
    { IDS_Menu1_Full_Screen, "全屏显示\tF4" },
    { IDS_Menu1_Select_Table, "选定桌面" },
    { IDS_Menu1_Select_Players, "选定玩家" },
    ...
    { IDS_Menu1_Table_Resolution, "桌面分辨率" },
    { IDS_Menu1_MaximumResolution, "使用最大分辨率" },
    { IDS_Menu1_640x480, "640 x 480" },
    { IDS_Menu1_800x600, "800 x 600" },
    { IDS_Menu1_1024x768, "1024 x 768" },
    { IDS_Menu1_Window, "窗口" },
    { IDS_Menu1_WindowUniformScale, "锁定宽高比缩放" },
    { IDS_Menu1_AlternativeRender, "使用替代方式渲染" },
    { IDS_Menu1_Help, "帮助" },
    { IDS_Menu1_Help_Topics, "帮助主题\tF1" },
    { IDS_Menu1_About_Pinball, "关于弹球" },
    ...
    { IDS_KEYMAPPER_Default, "默认值" },
    { IDS_KEYMAPPER_FlipperL, "左挡板" },
    { IDS_KEYMAPPER_FlipperR, "右挡板" },
    { IDS_KEYMAPPER_BumpLeft, "左桌凸块" },
    { IDS_KEYMAPPER_BumpRight, "右桌凸块" },
    { IDS_KEYMAPPER_BumpBottom, "底桌凸块" },
    { IDS_KEYMAPPER_Plunger, "撞针" },
    ...
    { IDS_Menu1_UseMaxResolution_640x480, "使用最大分辨率 (640 x 480)" },
    { IDS_Menu1_UseMaxResolution_800x600, "使用最大分辨率 (800 x 600)" },
    { IDS_Menu1_UseMaxResolution_1024x768, "使用最大分辨率 (1024 x 768)" },
};
