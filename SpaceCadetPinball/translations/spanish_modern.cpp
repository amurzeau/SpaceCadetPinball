...
const std::map<uint32_t, const char*> rc_strings_spanish_modern = {
    ...
    { IDS_Menu1_Player_Controls, "Controles..." },
    ...
    { IDS_Menu1_Help_Topics, "Temas de Ayuda" },
