...
const std::map<uint32_t, const char*> rc_strings_spanish_modern = {
    ...
    { IDS_Menu1_High_Scores, "P&untuaciones más altas..." },
    ...
    { IDS_Menu1_Player_Controls, "Contro&les...\tF8" },
    ...
    { IDS_KEYMAPPER_Default, "Prede&terminados" },
    { IDS_KEYMAPPER_FlipperL, "Imp&ulsor izquierdo" },
    { IDS_KEYMAPPER_FlipperR, "&Impulsor derecho" },
    { IDS_KEYMAPPER_BumpLeft, "Golpear el lado i&zquierdo" },
