...
const std::map<uint32_t, const char*> rc_strings_dutch = {
    { IDS_Menu1_Game, "&Spel" },
    { IDS_Menu1_New_Game, "&Nieuw spel\tF2" },
    { IDS_Menu1_Launch_Ball, "&Bal in spel brengen" },
    { IDS_Menu1_Pause_Resume_Game, "&Spel onderbreken/hervatten\tF3" },
    { IDS_Menu1_High_Scores, "&Topscores..." },
    { IDS_Menu1_Demo, "&Demo" },
    { IDS_Menu1_Exit, "&Afsluiten" },
    { IDS_Menu1_Options, "&Opties" },
    { IDS_Menu1_Full_Screen, "&Volledig scherm\tF4" },
    { IDS_Menu1_Select_Table, "&Kast selecteren" },
    { IDS_Menu1_Select_Players, "Spe&lers selecteren" },
    ...
    { IDS_Menu1_Player_Controls, "Spel&functies...\tF8" },
    ...
    { IDS_Menu1_Help, "&Help" },
    { IDS_Menu1_Help_Topics, "Help-&onderwerpen\tF1" },
    ...
    { IDS_KEYMAPPER_BumpLeft, "Duw naar r&echts" },
    { IDS_KEYMAPPER_BumpRight, "Duw naar li&nks" },
    { IDS_KEYMAPPER_BumpBottom, "Duw van &onderen" },
    { IDS_KEYMAPPER_Plunger, "Lan&ceerknop" },
