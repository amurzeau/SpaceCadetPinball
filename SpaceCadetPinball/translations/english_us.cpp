...
const std::map<uint32_t, const char*> rc_strings_english_us = {
    { IDS_Menu1_Game, "Game" },
    { IDS_Menu1_New_Game, "New Game" },
    { IDS_Menu1_Launch_Ball, "Launch Ball" },
    { IDS_Menu1_Pause_Resume_Game, "Pause/Resume Game" },
    { IDS_Menu1_High_Scores, "High Scores..." },
    { IDS_Menu1_Demo, "Demo" },
    { IDS_Menu1_Exit, "Exit" },
    { IDS_Menu1_Options, "Options" },
    { IDS_Menu1_Full_Screen, "Full Screen" },
    ...
    { IDS_Menu1_Player_Controls, "Player Controls..." },
    ...
    { IDS_Menu1_Help, "Help" },
    { IDS_Menu1_Help_Topics, "Help Topics" },
