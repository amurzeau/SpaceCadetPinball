#include "../pinball.h"
#include "english_us.h"

const std::map<uint32_t, const char*> rc_strings_english_us = {
    { IDS_Menu1_Game, "&Game" },
    { IDS_Menu1_New_Game, "&New Game\tF2" },
    { IDS_Menu1_Launch_Ball, "&Launch Ball" },
    { IDS_Menu1_Pause_Resume_Game, "&Pause/Resume Game\tF3" },
    { IDS_Menu1_High_Scores, "&High Scores..." },
    { IDS_Menu1_Demo, "&Demo" },
    { IDS_Menu1_Exit, "E&xit" },
    { IDS_Menu1_Options, "&Options" },
    { IDS_Menu1_Full_Screen, "&Full Screen\tF4" },
    { IDS_Menu1_Select_Table, "Select &Table" },
    { IDS_Menu1_Select_Players, "Select &Players" },
    { IDS_Menu1_1Player, "&1 Player" },
    { IDS_Menu1_2Players, "&2 Players" },
    { IDS_Menu1_3Players, "&3 Players" },
    { IDS_Menu1_4Players, "&4 Players" },
    { IDS_Menu1_Sounds, "&Sounds" },
    { IDS_Menu1_Music, "&Music" },
    { IDS_Menu1_Player_Controls, "P&layer Controls...\tF8" },
    ...
    { IDS_Menu1_Help, "&Help" },
    { IDS_Menu1_Help_Topics, "&Help Topics\tF1" },
    { IDS_Menu1_About_Pinball, "&About Pinball" },
    { IDS_HIGHSCORES_Caption, "High Scores" },
    { IDS_HIGHSCORES_Ok, "OK" },
    { IDS_HIGHSCORES_Cancel, "Cancel" },
    { IDS_HIGHSCORES_Clear, "&Clear" },
    { IDS_HIGHSCORES_Name, "Name" },
    { IDS_HIGHSCORES_Score, "Score" },
    { IDS_HIGHSCORES_Rank, "Rank" },
    { IDS_HIGHSCORES_Rank1, "1" },
    { IDS_HIGHSCORES_Rank2, "2" },
    { IDS_HIGHSCORES_Rank3, "3" },
    { IDS_HIGHSCORES_Rank4, "4" },
    { IDS_HIGHSCORES_Rank5, "5" },
    { IDS_KEYMAPPER_Caption, "3D Pinball: Player Controls" },
    { IDS_KEYMAPPER_Ok, "OK" },
    { IDS_KEYMAPPER_Cancel, "Cancel" },
    { IDS_KEYMAPPER_Default, "&Default" },
    { IDS_KEYMAPPER_FlipperL, "&Left Flipper" },
    { IDS_KEYMAPPER_FlipperR, "Right &Flipper" },
    { IDS_KEYMAPPER_BumpLeft, "Left &Table Bump" },
    { IDS_KEYMAPPER_BumpRight, "&Right Table Bump" },
    { IDS_KEYMAPPER_BumpBottom, "&BottomTable Bump" },
    { IDS_KEYMAPPER_Plunger, "&Plunger" },
    { IDS_KEYMAPPER_Help1, "To change game controls, choose the control options you want, click the Arrow buttons to change specific keys, and then choose OK." },
    { IDS_KEYMAPPER_Help2, "To restore 3D Pinball to its original settings, choose Default, and then choose OK. To use the Arrow keys on the numeric keypad, make sure NUMLOCK is off." },
    { IDS_KEYMAPPER_Groupbox1, "Control Options" },
