...
const std::map<uint32_t, const char*> rc_strings_czech = {
    ...
    { IDS_Menu1_Player_Controls, "Ovládání hry..." },
    ...
    { IDS_Menu1_Help_Topics, "Témata nápovědy" },
