...
const std::map<uint32_t, const char*> rc_strings_czech = {
    ...
    { IDS_Menu1_High_Scores, "Nejlepší výsledky..." },
    ...
    { IDS_Menu1_Select_Players, "Počet hráčů" },
    ...
    { IDS_KEYMAPPER_FlipperR, "Pravá páka" },
    { IDS_KEYMAPPER_BumpLeft, "Levý nárazník" },
    { IDS_KEYMAPPER_BumpRight, "Pravý nárazník" },
