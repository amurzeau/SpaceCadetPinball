...
const std::map<uint32_t, const char*> rc_strings_swedish = {
    ...
    { IDS_Menu1_Launch_Ball, "S&kjut iväg kulan" },
    { IDS_Menu1_Pause_Resume_Game, "&Pausa/fortsätt\tF3" },
    { IDS_Menu1_High_Scores, "P&oängrekord..." },
    { IDS_Menu1_Demo, "&Demo" },
    { IDS_Menu1_Exit, "&Avsluta" },
    { IDS_Menu1_Options, "Alternati&v" },
    ...
    { IDS_Menu1_Player_Controls, "Spel&kontroller...\tF8" },
    ...
    { IDS_KEYMAPPER_FlipperL, "Vä&nster flipper" },
    { IDS_KEYMAPPER_FlipperR, "H&öger flipper" },
