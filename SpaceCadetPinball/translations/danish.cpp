...
const std::map<uint32_t, const char*> rc_strings_danish = {
    { IDS_Menu1_Game, "&Spil" },
    { IDS_Menu1_New_Game, "&Nyt spil\tF2" },
    { IDS_Menu1_Launch_Ball, "Affyr &kugle" },
    { IDS_Menu1_Pause_Resume_Game, "A&fbryd/Fortsæt spil\tF3" },
    { IDS_Menu1_High_Scores, "&Point..." },
    { IDS_Menu1_Demo, "&Demo" },
    { IDS_Menu1_Exit, "&Afslut" },
    { IDS_Menu1_Options, "&Indstillinger" },
    { IDS_Menu1_Full_Screen, "&Fuld skærm\tF4" },
    { IDS_Menu1_Select_Table, "&Vælg bord" },
    { IDS_Menu1_Select_Players, "Vælg sp&illere" },
    ...
    { IDS_Menu1_Player_Controls, "&Styreredskaber for spiller...\tF8" },
    ...
    { IDS_Menu1_Help_Topics, "&Emner i Hjælp\tF1" },
