...
const std::map<uint32_t, const char*> rc_strings_finnish = {
    ...
    { IDS_Menu1_Player_Controls, "Pelin ohjaimet..." },
    ...
    { IDS_Menu1_Help, "Ohje" },
    { IDS_Menu1_Help_Topics, "Ohjeen aiheet" },
