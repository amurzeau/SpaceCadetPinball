...
const std::map<uint32_t, const char*> rc_strings_finnish = {
    ...
    { IDS_Menu1_Launch_Ball, "Laukaise pallo" },
    { IDS_Menu1_Pause_Resume_Game, "Pysäytä/jatka peliä\tF3" },
    ...
    { IDS_Menu1_Select_Players, "Valitse pelaajat" },
    ...
    { IDS_KEYMAPPER_Default, "Oletus" },
    { IDS_KEYMAPPER_FlipperL, "Vasen siipi" },
    { IDS_KEYMAPPER_FlipperR, "Oikea siipi" },
    { IDS_KEYMAPPER_BumpLeft, "Vasemman reunan tönäisy" },
    { IDS_KEYMAPPER_BumpRight, "Oikean reunan tönäisy" },
    { IDS_KEYMAPPER_BumpBottom, "Alareunan tönäisy" },
    { IDS_KEYMAPPER_Plunger, "Vetojousi" },
