...
const std::map<uint32_t, const char*> rc_strings_hungarian = {
    ...
    { IDS_Menu1_Player_Controls, "Mozgató billentyűk..." },
    ...
    { IDS_Menu1_Help, "Súgó" },
    { IDS_Menu1_Help_Topics, "Témakörök" },
