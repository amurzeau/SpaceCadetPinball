...
const std::map<uint32_t, const char*> rc_strings_hungarian = {
    ...
    { IDS_Menu1_New_Game, "Új já&ték\tF2" },
    ...
    { IDS_Menu1_Player_Controls, "Mozgató b&illentyűk...\tF8" },
    ...
    { IDS_KEYMAPPER_BumpRight, "Asztalba rúgás j&obbról" },
    { IDS_KEYMAPPER_BumpBottom, "As&ztalba rúgás alulról" },
