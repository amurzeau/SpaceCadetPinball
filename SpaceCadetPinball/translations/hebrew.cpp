...
const std::map<uint32_t, const char*> rc_strings_hebrew = {
    ...
    { IDS_Menu1_Player_Controls, "מקשי משחק..." },
    ...
    { IDS_Menu1_Help, "עזרה" },
    { IDS_Menu1_Help_Topics, "נושאי עזרה" },
