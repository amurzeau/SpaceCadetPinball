...
const std::map<uint32_t, const char*> rc_strings_hebrew = {
    { IDS_Menu1_Game, "&משחק" },
    { IDS_Menu1_New_Game, "משחק &חדש\tF2" },
    { IDS_Menu1_Launch_Ball, "&שגר כדור" },
    { IDS_Menu1_Pause_Resume_Game, "&השהה/חדש משחק\tF3" },
    { IDS_Menu1_High_Scores, "&ניקוד גבוה..." },
    { IDS_Menu1_Demo, "הד&גמה" },
    { IDS_Menu1_Exit, "י&ציאה" },
    { IDS_Menu1_Options, "&אפשרויות" },
    { IDS_Menu1_Full_Screen, "&מסך מלא\tF4" },
    { IDS_Menu1_Select_Table, "בחר &שולחן" },
    { IDS_Menu1_Select_Players, "ב&חר שחקנים" },
    { IDS_Menu1_1Player, "שחקן &אחד" },
    { IDS_Menu1_2Players, "&שני שחקנים" },
    { IDS_Menu1_3Players, "ש&לושה שחקנים" },
    { IDS_Menu1_4Players, "אר&בעה שחקנים" },
    { IDS_Menu1_Sounds, "&צלילים" },
    { IDS_Menu1_Music, "מו&סיקה" },
    { IDS_Menu1_Player_Controls, "מ&קשי משחק...\tF8" },
    ...
    { IDS_Menu1_Help, "ע&זרה" },
    { IDS_Menu1_Help_Topics, "&נושאי עזרה\tF1" },
    { IDS_Menu1_About_Pinball, "&אודות Pinball" },
    { IDS_HIGHSCORES_Caption, "ניקוד גבוה" },
    { IDS_HIGHSCORES_Ok, "אישור" },
    { IDS_HIGHSCORES_Cancel, "ביטול" },
    { IDS_HIGHSCORES_Clear, "&נקה" },
    { IDS_HIGHSCORES_Name, "שם" },
    { IDS_HIGHSCORES_Score, "תוצאה" },
    { IDS_HIGHSCORES_Rank, "דירוג" },
    { IDS_HIGHSCORES_Rank1, "1" },
    { IDS_HIGHSCORES_Rank2, "2" },
    { IDS_HIGHSCORES_Rank3, "3" },
    { IDS_HIGHSCORES_Rank4, "4" },
    { IDS_HIGHSCORES_Rank5, "5" },
    { IDS_KEYMAPPER_Caption, "Pinball תלת-מימדי: מקשי משחק" },
    { IDS_KEYMAPPER_Ok, "אישור" },
    { IDS_KEYMAPPER_Cancel, "ביטול" },
    { IDS_KEYMAPPER_Default, "ב&רירת מחדל" },
    { IDS_KEYMAPPER_FlipperL, "&פליפר שמאלי" },
    { IDS_KEYMAPPER_FlipperR, "פ&ליפר ימני" },
    { IDS_KEYMAPPER_BumpLeft, "דחיפת שולחן משמ&אל" },
    { IDS_KEYMAPPER_BumpRight, "דחיפת שולחן מי&מין" },
    { IDS_KEYMAPPER_BumpBottom, "דחיפת שולחן מלמ&טה" },
    { IDS_KEYMAPPER_Plunger, "&ידית הפעלה" },
    { IDS_KEYMAPPER_Help1, "כדי לשנות את מקשי המשחק, בחר באפשרויות הבקרה הרצויות, לחץ על לחצני החיצים כדי לשנות מקשים ספציפיים ולאחר מכן לחץ על אישור." },
    { IDS_KEYMAPPER_Help2, "כדי לשחזר את ההגדרות המקוריות של Pinball תלת-מימדי, לחץ על ברירת מחדל ולאחר מכן לחץ על אישור. כדי להשתמש במקשי החיצים במקלדת הנומרית, ודא כי מקש NUMLOCK אינו פעיל." },
    { IDS_KEYMAPPER_Groupbox1, "אפשרויות בקרה" },
    { IDS_KEYMAPPER_Groupbox2, "הוראות" },
