...
const std::map<uint32_t, const char*> rc_strings_hebrew = {
    ...
    { IDS_Menu1_Demo, "הדגמה" },
    { IDS_Menu1_Exit, "יציאה" },
    { IDS_Menu1_Options, "אפשרויות" },
    { IDS_Menu1_Full_Screen, "מסך מלא\tF4" },
    { IDS_Menu1_Select_Table, "בחר שולחן" },
    { IDS_Menu1_Select_Players, "בחר שחקנים" },
    { IDS_Menu1_1Player, "שחקן אחד" },
    { IDS_Menu1_2Players, "שני שחקנים" },
    { IDS_Menu1_3Players, "שלושה שחקנים" },
    { IDS_Menu1_4Players, "ארבעה שחקנים" },
    { IDS_Menu1_Sounds, "צלילים" },
    { IDS_Menu1_Music, "מוסיקה" },
    { IDS_Menu1_Player_Controls, "מקשי משחק...\tF8" },
    ...
    { IDS_KEYMAPPER_Default, "ברירת מחדל" },
    { IDS_KEYMAPPER_FlipperL, "פליפר שמאלי" },
    { IDS_KEYMAPPER_FlipperR, "פליפר ימני" },
    { IDS_KEYMAPPER_BumpLeft, "דחיפת שולחן משמאל" },
    { IDS_KEYMAPPER_BumpRight, "דחיפת שולחן מימין" },
    { IDS_KEYMAPPER_BumpBottom, "דחיפת שולחן מלמטה" },
