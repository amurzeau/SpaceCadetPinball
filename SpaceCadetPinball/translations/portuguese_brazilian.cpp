...
const std::map<uint32_t, const char*> rc_strings_portuguese_brazilian = {
    ...
    { IDS_Menu1_About_Pinball, "Sobre o Pinball" },
    ...
    { IDS_KEYMAPPER_Default, "Padrão" },
    { IDS_KEYMAPPER_FlipperL, "Palheta esquerda" },
