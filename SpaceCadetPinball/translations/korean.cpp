...
const std::map<uint32_t, const char*> rc_strings_korean = {
    { IDS_Menu1_Game, "게임(&G)" },
    { IDS_Menu1_New_Game, "새 게임(&N)\tF2" },
    { IDS_Menu1_Launch_Ball, "구슬 쏘기(&L)" },
    { IDS_Menu1_Pause_Resume_Game, "게임 일시 중지/계속(&P)\tF3" },
    { IDS_Menu1_High_Scores, "고득점(&H)..." },
    { IDS_Menu1_Demo, "데모(&D)" },
    { IDS_Menu1_Exit, "끝내기(&X)" },
    { IDS_Menu1_Options, "옵션(&O)" },
    { IDS_Menu1_Full_Screen, "전체 화면(&F)\tF4" },
    { IDS_Menu1_Select_Table, "테이블 선택(&T)" },
    { IDS_Menu1_Select_Players, "게임 인원 선택(&P)" },
    { IDS_Menu1_1Player, "1명(&1)" },
    { IDS_Menu1_2Players, "2명(&2)" },
    { IDS_Menu1_3Players, "3명(&3)" },
    { IDS_Menu1_4Players, "4명(&4)" },
    { IDS_Menu1_Sounds, "소리(&S)" },
    { IDS_Menu1_Music, "음악(&M)" },
    { IDS_Menu1_Player_Controls, "게임 진행키 설정(&L)...\tF8" },
    ...
    { IDS_Menu1_Help, "도움말(&H)" },
    { IDS_Menu1_Help_Topics, "도움말 항목(&H)\tF1" },
    { IDS_Menu1_About_Pinball, "핀볼 정보(&A)" },
    { IDS_HIGHSCORES_Caption, "고득점" },
    { IDS_HIGHSCORES_Ok, "확인" },
    { IDS_HIGHSCORES_Cancel, "취소" },
    { IDS_HIGHSCORES_Clear, "지우기(&C)" },
    ...
    { IDS_KEYMAPPER_Default, "기본값(&D)" },
    { IDS_KEYMAPPER_FlipperL, "왼쪽 공격막대(&L)" },
    { IDS_KEYMAPPER_FlipperR, "오른쪽 공격막대(&F)" },
    { IDS_KEYMAPPER_BumpLeft, "테이블 왼쪽 흔들기(&T)" },
    { IDS_KEYMAPPER_BumpRight, "테이블 오른쪽 흔들기(&R)" },
    { IDS_KEYMAPPER_BumpBottom, "테이블 아래쪽 흔들기(&B)" },
    { IDS_KEYMAPPER_Plunger, "구슬 쏘기(&P)" },
