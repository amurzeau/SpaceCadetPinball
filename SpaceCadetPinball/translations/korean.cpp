...
const std::map<uint32_t, const char*> rc_strings_korean = {
    { IDS_Menu1_Game, "게임" },
    { IDS_Menu1_New_Game, "새 게임\tF2" },
    { IDS_Menu1_Launch_Ball, "구슬 쏘기" },
    { IDS_Menu1_Pause_Resume_Game, "게임 일시 중지/계속\tF3" },
    { IDS_Menu1_High_Scores, "고득점..." },
    { IDS_Menu1_Demo, "데모" },
    { IDS_Menu1_Exit, "끝내기" },
    { IDS_Menu1_Options, "옵션" },
    { IDS_Menu1_Full_Screen, "전체 화면\tF4" },
    ...
    { IDS_Menu1_Sounds, "소리" },
    { IDS_Menu1_Music, "음악" },
    { IDS_Menu1_Player_Controls, "게임 진행키 설정...\tF8" },
    ...
    { IDS_Menu1_Help, "도움말" },
    { IDS_Menu1_Help_Topics, "도움말 항목\tF1" },
