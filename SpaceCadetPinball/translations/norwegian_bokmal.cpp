...
const std::map<uint32_t, const char*> rc_strings_norwegian_bokmal = {
    ...
    { IDS_Menu1_Player_Controls, "Spillkontroller..." },
    ...
    { IDS_Menu1_Help_Topics, "Emner i Hjelp" },
