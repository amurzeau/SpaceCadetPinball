...
const std::map<uint32_t, const char*> rc_strings_french = {
    ...
    { IDS_Menu1_New_Game, "&Nouvelle partie\tF2" },
    { IDS_Menu1_Launch_Ball, "&Lancer la balle" },
    { IDS_Menu1_Pause_Resume_Game, "&Suspendre/Reprendre la partie\tF3" },
    { IDS_Menu1_High_Scores, "Meilleurs s&cores..." },
    { IDS_Menu1_Demo, "&Démonstration" },
    { IDS_Menu1_Exit, "&Quitter" },
    { IDS_Menu1_Options, "&Options" },
    { IDS_Menu1_Full_Screen, "P&lein écran\tF4" },
    { IDS_Menu1_Select_Table, "Sélectionner un ta&bleau" },
    { IDS_Menu1_Select_Players, "Ch&oisir les joueurs" },
    ...
    { IDS_Menu1_Player_Controls, "Contrôl&es de jeu...\tF8" },
    ...
    { IDS_Menu1_Help, "&?" },
    { IDS_Menu1_Help_Topics, "&Rubriques d'aide\tF1" },
    ...
    { IDS_KEYMAPPER_FlipperR, "Flipp&er droit" },
    { IDS_KEYMAPPER_BumpLeft, "&Bourrage à gauche" },
    { IDS_KEYMAPPER_BumpRight, "B&ourrage à droite" },
    { IDS_KEYMAPPER_BumpBottom, "Bo&urrage en bas" },
